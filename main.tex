...
In the last chapter, I present the workings of a web-app I've been working on that solves some of the visualisation hurdles when trying to verify oscillatory properties of chemical reaction networks.
\tableofcontents
