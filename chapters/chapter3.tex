...
$Re(\lambda) \leqslant  0 \forall \lambda \in Eig(J(y_f)) \text{ and } \exists \lambda : Re(\lambda) = 0 $ the results are inconclusive and can't be implied for the non-linear system. Further analysis, which, like (DAE)'s is beyond the scope of this thesis (and my current knowledge), but maybe one day..
