...
To better define and illustrate them for the 1-D case and give example of bifurcations for such dimension, we could instead write our vector field $f$ as depending on $\mu$ as well as the unknown function $y$.
...
if $\forall \lambda \in Eig(J_{f}(y_0,\lambda_0)) : Re(\lambda) <= 0$, and $\exists \lambda_0 : Re(\lambda_0) = 0 \implies$
