...
\begin{definition}
  $(y_0, \mu_0)$ admits a \textbf{Hobf bifurcation} if, we have Def. \ref{local_bif_def}, and additionally:
  \begin{equation}\label{hobf_bif_def}
    Im(\lambda_0) \neq 0.
  \end{equation}
\end{definition}
\newpage
...
\includegraphics[width=13cm]{math_pics/hobf-bif-eigenvalue-graph.png}
...
So having these in mind, Hobf is kind of like a $\mathbb{R}^2$ version of Pitchfork bif.: \ref{pitchfork_bif} when you think about it.
