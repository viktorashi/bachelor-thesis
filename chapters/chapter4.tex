...
c_{i+1,j} = c_{i,j+1} \cdot \frac{c_{i-1,0}}{c_{i0}} - c_{i-1,j+1 } = \frac{1}{c_{i0}} \text{det}
\begin{pmatrix}
c_{i-1,0} & c_{i-1, j+1} \\
...
The algo. stops at $ p_m(x) $ with $ m < n$ if $c_{i0} = 0$ at a particular $i \implies q_i(x)$ is of higher degree.
