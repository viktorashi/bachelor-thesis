...
But the problem is this theorem only holds for $\mathbb{R}^2$. For higher dimensions we don't have this property necessarily, instead we have to have to look for limit cycles ourselves. These can be found in the aforementioned \ref{hopf_bif_def}
